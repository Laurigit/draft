...
createNewDecklist_after_draft <- function(new_DCIDs, Pakka_ID_input, STG_CARDS, STG_CARDS_DIM, STG_DRAFT_CARDS) {
  ...
  new_MIDs <- STG_DRAFT_CARDS[DRAFT_CARDS_ID %in% new_DCIDs, .(MID)]
